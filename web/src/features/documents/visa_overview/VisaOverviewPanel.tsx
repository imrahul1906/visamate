...
// ✅ This component is purely layout/orchestration — all data derivation
//    lives in useVisaOverviewData, all sub-UI lives in sibling files.
//
// Data flow:
//   Parent calls getVisaType(countryCode, visaTypeCode) from repository.ts
//   → passes result as `visaType` prop here.
//   This component never touches the repository.
          ...
          >
            ...
            <div>
              ...
              >
                ...
                <strong style={{ color: T.text }}>NOT UNIVERSAL</strong> — they apply only to
                the specific{" "}
                <strong style={{ color: T.text }}>DROP OFF OFFICES</strong> listed below. If
                you are not using these offices, standard payment methods apply.
              </p>
            </div>
          </div>
