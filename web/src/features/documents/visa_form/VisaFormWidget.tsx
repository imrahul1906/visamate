...
//
// Theme tokens now imported from shared theme instead of being redeclared locally.
...
export default function VisaFormWidget({
  ...
  const toggleSection = (sectionName: string) => {
    setCollapsedSections((prev) => toggleSectionState(prev, sectionName));
  };

  // Auto-select first field once loaded; collapse all sections except the first
  useEffect(() => {
  ...
  const toggleDone = (id: string) => {
    setDoneFields((prev) => toggleDoneState(prev, id));
  };
