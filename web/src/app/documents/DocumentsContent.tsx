...
import type { DocumentData, DocumentItem, UploadsMap } from "./types";
...
// ─────────────────────────────────────────────────────────────
// Styling constants — dark navy theme
// ─────────────────────────────────────────────────────────────
const C = {
  bg:          "#0d0d1f",
  surface:     "#13132a",
    ...
    <div style={{
      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .vm-left-scroll::-webkit-scrollbar { width: 4px; }
        .vm-left-scroll::-webkit-scrollbar-track { background: rgba(99,102,241,0.05); border-radius: 2px; }
        .vm-left-scroll::-webkit-scrollbar-thumb { background: rgba(99,102,241,0.4); border-radius: 2px; }
        .vm-left-scroll::-webkit-scrollbar-thumb:hover { background: rgba(99,102,241,0.65); }

        .vm-right-scroll::-webkit-scrollbar { width: 4px; }
        .vm-right-scroll::-webkit-scrollbar-track { background: rgba(99,102,241,0.05); border-radius: 2px; }
        .vm-right-scroll::-webkit-scrollbar-thumb { background: rgba(99,102,241,0.4); border-radius: 2px; }
        .vm-right-scroll::-webkit-scrollbar-thumb:hover { background: rgba(99,102,241,0.65); }
          ...
          >
            ...
            <div style={{
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
                <span style={{ fontSize: 10, fontWeight: 700, color: C.muted, textTransform: "uppercase", letterSpacing: "0.07em", fontFamily: "'DM Sans', sans-serif" }}>
                  Checklist
                </span>
                <span style={{ fontSize: 11, fontWeight: 600, color: C.indigoLight, fontFamily: "'DM Sans', sans-serif" }}>
                  {totalDone}/{allDocs.length} ready
                </span>
              </div>
              <div style={{ height: 3, background: "rgba(255,255,255,0.07)", borderRadius: 2, overflow: "hidden" }}>
                <div style={{
                  height: "100%", width: `${overallPct}%`,
                  background: `linear-gradient(90deg, ${C.indigo}, ${C.indigoLight})`,
                  borderRadius: 2, transition: "width 400ms ease",
                }} />
              </div>
            </div>
...
>
                            ...
                            <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 3, flexShrink: 0 }}>
                              {isUploaded && (
                                <span className="vm-badge" style={{ background: "rgba(74,222,128,0.15)", color: C.green, border: "1px solid rgba(74,222,128,0.25)" }}>
                                  ✓
                                </span>
                              )}
                              {badge && !isUploaded && (
                                <span className="vm-badge" style={{ background: "rgba(99,102,241,0.15)", color: C.indigoLight, border: "1px solid rgba(99,102,241,0.25)" }}>
                                  {badge}
                                </span>
                              )}
                            </div>
                            ...
                            {/* Chevron */}
                            <svg
                              width="12" height="12" fill="none" stroke={isActive ? C.indigoLight : C.muted}
              ...
              <div style={{
                ...
                <p style={{ fontSize: 10, fontWeight: 700, color: C.amber, margin: "0 0 3px", fontFamily: "'DM Sans', sans-serif" }}>
                  💡 Pro Tip
                </p>
                <p style={{ fontSize: 10, color: C.muted, margin: 0, lineHeight: 1.6, fontFamily: "'DM Sans', sans-serif" }}>
...
minWidth: 0,          // ← prevents flex overflow
  minHeight: 0,
              ...
              flexDirection: "column",
              overflow: "hidden",
              background: isMobile && drawerOpen ? C.surface : "transparent",
            }}
          >
            {!activeDoc ? (
              // Empty state
              <div style={{
                ...
                <p style={{
                  fontSize: 15, fontWeight: 600, color: C.text, margin: "0 0 8px",
                  fontFamily: "'DM Serif Display', serif",
                }}>
                  Select a document
                </p>
                <p style={{
                  fontSize: 12, color: C.muted, margin: 0, lineHeight: 1.7,
              ...
              <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
                ...
                <div style={{
                  ...
                  <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                    ...
                    {!activeDoc.noUpload && (
                      <span style={{
                        fontSize: 10, fontWeight: 600, color: C.indigoLight,
                ...
                >
                  ...
                  {(activeDoc.notes || activeDoc.tips?.length) && (
                    <div style={{
                      ...
                      {activeDoc.notes && (
                        <p style={{ fontSize: 12, color: C.muted2, margin: "0 0 8px", lineHeight: 1.6, fontFamily: "'DM Sans', sans-serif" }}>
                          ℹ️ {activeDoc.notes}
                        </p>
                      )}
                      {activeDoc.tips?.map((tip, i) => (
                        <div key={i} style={{ display: "flex", gap: 7, marginBottom: 5, alignItems: "flex-start" }}>
                          <span style={{ color: C.indigoLight, marginTop: 1, flexShrink: 0, fontSize: 12 }}>→</span>
                          <span style={{ fontSize: 12, color: C.muted2, lineHeight: 1.5, fontFamily: "'DM Sans', sans-serif" }}>
                            {tip}
                          </span>
                        </div>
                      ))}
                      {activeDoc.acceptedFormats && activeDoc.acceptedFormats.length > 0 && (
                        <div style={{ marginTop: 8 }}>
                          <p style={{ fontSize: 10, fontWeight: 700, color: C.indigoLight, margin: "0 0 5px", textTransform: "uppercase", letterSpacing: "0.07em", fontFamily: "'DM Sans', sans-serif" }}>
                            Accepted formats
                          </p>
                  ...
                  {/* THE HELPER — rendered via DocHelper */}
                  <DocHelper
                    doc={activeDoc}
                    color={activeCategory?.color ?? C.indigo}
                    uploads={uploads}
