...
import ItineraryWidget from "./ItineraryWidget.tsx";   // no .tsx extension

// ─────────────────────────────────────────────────────────────
// DocumentRow — a single expandable document checklist item
// ─────────────────────────────────────────────────────────────
...
export default function DocumentRow({
  ...
  itineraryData?: ItineraryPlacesData | null;  // injected from DocumentsContent via CategorySection
}) {
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "14px 16px", display: "flex", alignItems: "flex-start", gap: 12 }}>
        ...
        <button
          ...
          style={{
            ...
            cursor: "pointer", transition: "all 180ms ease", marginTop: 1,
          }}
        >
          {checked && (
      ...
      {/* ── Expanded panel — stopPropagation prevents collapse on inner clicks ── */}
      {expanded && (
            ...
            <div style={{ borderTop: `1px solid ${color}18`, background: `${color}06`, padding: "10px 16px 12px 50px" }}>
              ...
              {(doc.acceptedFormats?.length ?? 0) > 0 && (
                <div style={{ marginTop: 8 }}>
                  <p style={{ fontSize: 11, fontWeight: 700, color, margin: "0 0 4px", textTransform: "uppercase", letterSpacing: "0.06em" }}>Accepted Formats</p>
