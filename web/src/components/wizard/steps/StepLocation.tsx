...
const drawerScrollbarStyle = `
  .vfs-drawer-scroll::-webkit-scrollbar {
    width: 5px;
  }
  .vfs-drawer-scroll::-webkit-scrollbar-track {
    background: rgba(255, 255, 255, 0.04);
    border-radius: 99px;
  }
  .vfs-drawer-scroll::-webkit-scrollbar-thumb {
    background: rgba(108, 92, 231, 0.45);
    border-radius: 99px;
  }
  .vfs-drawer-scroll::-webkit-scrollbar-thumb:hover {
    background: rgba(108, 92, 231, 0.7);
  }
  .vfs-drawer-scroll {
    scrollbar-width: thin;
    scrollbar-color: rgba(108, 92, 231, 0.45) rgba(255, 255, 255, 0.04);
  }
`;
...
function CenterDrawer({ info, onClose }: { info: VfsCenterInfo; onClose: () => void }) {
  ...
  const drawer = (
    <>
      <style>{drawerScrollbarStyle}</style>
      ...
      <div className="vfs-drawer-scroll" style={modalStyle}>
        {isMobile && (
