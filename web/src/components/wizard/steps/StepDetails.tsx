...
function ToggleGroup({
  ...
  return (
    <div>
      <div style={{ color: "rgba(255,255,255,0.4)", fontSize: 11, fontWeight: 500, marginBottom: 10, textTransform: "uppercase", letterSpacing: "0.06em" }}>
        {label}
      </div>
          ...
          return (
            <button
              ...
              style={{
                ...
                color: active ? "#a89cef" : "rgba(255,255,255,0.5)",
                fontSize: 12, fontWeight: 500,
                cursor: "pointer",
                transition: "all 0.15s",
                fontFamily: "inherit",
              }}
              onMouseEnter={e => { if (!active) { e.currentTarget.style.background = "rgba(255,255,255,0.07)"; e.currentTarget.style.color = "rgba(255,255,255,0.7)"; } }}
            ...
            >
              <span style={{ color: active ? "#a89cef" : "rgba(255,255,255,0.35)" }}>{opt.icon}</span>
              {opt.label}
            </button>
          );
        })}
