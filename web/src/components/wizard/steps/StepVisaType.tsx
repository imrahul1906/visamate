            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                <div style={{
                  ...
                  background: isActive ? "rgba(108,92,231,0.25)" : "rgba(255,255,255,0.07)",
                  color: isActive ? "#a89cef" : "rgba(255,255,255,0.4)",
                ...
                <div>
                  <div style={{ color: isActive ? "#fff" : "rgba(255,255,255,0.75)", fontSize: 13, fontWeight: 500 }}>
                    {option.name}
                  </div>
